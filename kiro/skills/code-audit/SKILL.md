---
name: code-audit
description: Deep code audit that produces a structured bug report with human summary and agent fix instructions (TODO.md style). Use when reviewing code for bugs, security issues, or correctness problems.
---
