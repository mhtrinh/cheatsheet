...
- Do not describe: internal data structures, algorithm internals, lock strategies, implementation-specific details.
...
- Prefer files that define public interfaces over internal implementation details.
